...
Настройка плеера отличается от состояния плеера. Это разные вещи. Настройки - это значения параметров плеера по-умолчанию.
